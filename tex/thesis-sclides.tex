...
For $q = 3$, and the vertex cover $X$,
\pause
...
\node[circle,fill=black,inner sep=0.5pt,,minimum size=1mm] (v1) at (0,0) {};
\node[circle,fill=blue,inner sep=0.5pt,minimum size=1mm] (v2) at (1,-1) {};
\node[circle,fill=green,inner sep=0.5pt,minimum size=1mm] (v3) at (-1,-1) {};
\node[circle,fill=blue,inner sep=0.5pt,minimum size=1mm] (v4) at (-1,1) {};
\node[circle,fill=yellow,inner sep=0.5pt,minimum size=1mm] (v5) at (1,1) {};
\node[circle,fill=red,inner sep=0.5pt,minimum size=1mm] (v6) at (-1,0) {};
