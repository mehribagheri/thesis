...
def strategy_saturation_largest_first_modified(G, colors, clique):
...
def greedy_color(G,  clique, strategy='largest_first', interchange=False, ):
    ...
    colors = {}
    coloring_order = []
    nodes = strategy_saturation_largest_first_modified(G, colors, clique)
